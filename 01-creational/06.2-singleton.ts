...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!DatabaseConnection.instance) {
      ...
      console.log("%cDatabase connection created successfully", COLORS.green);
    }
  ...
  public connect(): void {
    ...
    if (!this.connected) {
      this.connected = true;
      console.log("%cConnected to the database successfully", COLORS.blue);
      return;
    }
    console.log(
      "%cCurrent database connection status: " +
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log("%cDisconnected from the database successfully", COLORS.red);
      return;
    }
    console.log(
      "%cCurrent database connection status: " +
